...
func (_m *Project) CreateProject(name string, parentID int, visibility go_gitlab.VisibilityValue) (*go_gitlab.Project, error) {
	ret := _m.Called(name, parentID, visibility)

	var r0 *go_gitlab.Project
	var r1 error
	if rf, ok := ret.Get(0).(func(string, int, go_gitlab.VisibilityValue) (*go_gitlab.Project, error)); ok {
		return rf(name, parentID, visibility)
	}
	if rf, ok := ret.Get(0).(func(string, int, go_gitlab.VisibilityValue) *go_gitlab.Project); ok {
	...
	if rf, ok := ret.Get(1).(func(string, int, go_gitlab.VisibilityValue) error); ok {
