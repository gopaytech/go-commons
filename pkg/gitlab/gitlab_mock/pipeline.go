...
func (_m *Pipeline) GetBySHA(projectId gitlab.NameOrId, sha string) ([]go_gitlab.PipelineInfo, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(gitlab.NameOrId, string) ([]go_gitlab.PipelineInfo, error)); ok {
		return rf(projectId, sha)
	}
...
func (_m *Pipeline) GetBySHAAndRef(projectId gitlab.NameOrId, sha string, ref string) ([]go_gitlab.PipelineInfo, error) {
	...
	var r0 []go_gitlab.PipelineInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(gitlab.NameOrId, string, string) ([]go_gitlab.PipelineInfo, error)); ok {
		return rf(projectId, sha, ref)
	}
