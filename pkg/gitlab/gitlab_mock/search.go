...
func (_m *Search) ProjectsByGroup(parent gitlab.NameOrId, name string) ([]*go_gitlab.Project, *go_gitlab.Response, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(gitlab.NameOrId, string) ([]*go_gitlab.Project, *go_gitlab.Response, error)); ok {
		return rf(parent, name)
	}
...
func (_m *Search) ProjectsByName(name string) ([]*go_gitlab.Project, *go_gitlab.Response, error) {
	...
	var r1 *go_gitlab.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(string) ([]*go_gitlab.Project, *go_gitlab.Response, error)); ok {
		return rf(name)
	}
