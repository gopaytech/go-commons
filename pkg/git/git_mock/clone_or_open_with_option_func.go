...
// CloneOrOpenWithOptionFunc is an autogenerated mock type for the CloneOrOpenWithOptionFunc type
type CloneOrOpenWithOptionFunc struct {
	mock.Mock
}

// Execute provides a mock function with given fields: destination, option
func (_m *CloneOrOpenWithOptionFunc) Execute(destination string, option *git.CloneOptions) (pkggit.Repository, error) {
